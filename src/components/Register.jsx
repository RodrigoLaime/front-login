        ...
        <form action="" onSubmit={(e) => onSubmit(e)}>
          <div className={styles.inputContainer}>
            <div className={styles.left}>
              ...
              <input onChange={(e) => onChange(e)} type="text" name="nombre" id="nombre" placeholder='Nombre' autoComplete='off' />
            </div>
            {/* <svg
            viewBox="0 0 30 32"
            fill="none"
          ...
          <div className={styles.formContainer}>
            <div className={styles.left}>
              ...
              <input onChange={(e) => onChange(e)} type="email" name="correo" id="correo" placeholder='Correo' autoComplete='off' />
            </div>
            {/*   <svg
            viewBox="0 0 30 24"
            fill="none"
          ...
          <div className={styles.formContainer}>
            <div className={styles.left}>
              ...
              <input onChange={(e) => onChange(e)} type="password" name="contraseña" id="contraseña" placeholder='Contraseña' autoComplete='off' />
            </div>
            {/*  <svg
            viewBox="0 0 30 30"
            fill="none"
